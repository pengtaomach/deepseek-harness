...
import { WebSearchAggregateCard } from './WebSearchAggregateCard.tsx'
import { AGENT_LOOP_NS, AgentLoopCardController } from './agent-loop-card-controller.ts'
import { SHELL_NS, BashCardController } from './bash-card-controller.ts'
import { ConfigurablePluginsTabController } from './tab-store.ts'
import { WEB_NS } from './web-card-controller.ts'
import { WEB_SEARCH_NS } from './web-search-card-controller.ts'
import { WEB_SEARCH_PPIO_NS } from './web-search-ppio-card-controller.ts'
import { WebSearchAggregateController } from './web-search-aggregate-controller.ts'
...
export type { WebSearchPpioCardFace, WebSearchPpioCardState } from './web-search-ppio-card-controller.ts'
export type { WebCardFace, WebCardState } from './web-card-controller.ts'
export type { WebSearchAggregateFace, WebSearchAggregateState } from './web-search-aggregate-controller.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  const webSearch = new WebSearchAggregateController(
    ctx.settingsScope.bind({ namespace: WEB_NS }),
    ctx.settingsScope.bind({ namespace: WEB_SEARCH_NS }),
    ctx.settingsScope.bind({ namespace: WEB_SEARCH_PPIO_NS }),
    api,
  )
